...
| **System Marker**       | An Entity Property whose subject is a lozenge-prefixed System concept (`◊outtake`, `◊pov`), or an Editorial Property resolution marker (`◊ACCEPTED`, `◊REJECTED`).              |
