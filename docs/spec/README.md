...
- [Part 9: Entity Properties](09-entity-properties.md) — The property grammar, modifiers, subject resolution, key normalisation, context vocabulary, and Position. Includes Decision Record B.6 Entity Property Grammar.
...
- [Part 12: Architecture](12-architecture.md) — The layered event-driven pipeline (Event Catcher through Consumers/Workers) and pacing. Includes Decision Record B.7 Architecture.
